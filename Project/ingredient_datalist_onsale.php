            ...
            <nav>
                <ul class="navbar-nav">
                    <li class="nav-item <?= $page_name == 'datalist' ? 'active' : '' ?> ">
                        <a class="nav-link" href="ingredient_datalist_onsale.php"><button type="button" class="btn btn-outline-warning" style="width:100px;">批量刪除</button></a>
                    </li>
                </ul>
            </nav>
                ...
                <ul class="pagination" style="margin:0;">
                    ...
                    for ($i = $p_start; $i < $p_end + 1; $i++) :
                        ...
                        <li class="page-item  <?= $i == $page ? 'active' : '' ?>">
                            <a class="page-link" style="margin:0 auto;" href="ingredient_datalist_onsale.php?page=<?php echo $i ?>"><?= $i ?></a>
                        </li>
                    <?php endfor; ?>
