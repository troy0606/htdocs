    ...
    <div class="row">
        ...
        <script>
            ...
            function check() {
                ...
                //     name.closest(".form-group").querySelector('small').innerText = "請輸入名稱";
                //     isPass = false;
                // }

                // if (!(mobilePattern).test(mobile.value)) {
                //     mobile.style.border = '1px solid red';
                //     mobile.closest(".form-group").querySelector('small').innerText = "請輸入電話號碼";
                //     isPass = false;
                // }

                // if (!(emailPattern).test(email.value)) {
                //     email.style.border = '1px solid red';
                //     email.closest(".form-group").querySelector('small').innerText = "請輸入正確電子郵箱號碼";
                //     isPass = false;
                // }
