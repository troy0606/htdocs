                ...
                <ul class="pagination" style="margin:0;">
                    ...
                    for ($i = $p_start; $i < $p_end + 1; $i++) :
                        ...
                        <li class="page-item  <?= $i == $page ? 'active' : '' ?>">
                            <a class="page-link d-flex justify-content-center" style="width:55px; margin:0 auto; color: #15141A;" href="ingredient_datalist_lack.php?<?= http_build_query($params) ?>"><?= $i ?></a>
                        </li>
